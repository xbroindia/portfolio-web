...
export default function About(){
  ...
  const[visible4,ref4]=Scroll_fade({threshold:0.5})
    return(
      <div className={`relative  min-h-[50vh] w-[100%]   scroll-mt-[70px] duration-[3s]`} ref={ref2} id='about'>
     ...
     <div className='mt-[10%] flex flex-col items-center  lg:flex-row justify-between mx-[50px]'>
        <img src={person1} className={`rounded-2xl  shadow-[0.1px_0.1px_60px_rgb(166,165,162)] h-[550px] md:h-[700px] w-[450px] ${visible1 ? " opacity-100 scale-100 rotate-y-0":"opacity-0 scale-50 rotate-y-[180deg]"} transition-all duration-[2s]  `} ref={ref1}/>
        ...
        <p className=' w-[350px] sm:w-[500px] text-[19px] md:text-[24px] text-center capitalize font-Montserrat'>
        ...
        <div className='flex flex-row gap-[2.5%] md:gap-[5%] mt-4 '>
         <img src={pic1} className='h-[65px] md:h-[80px]'/>
         <img src={pic2} className='h-[65px] md:h-[80px]'/>
         <img src={pic3} className='h-[65px] md:h-[80px]'/>
         <img src={pic4} className='h-[65px] md:h-[80px]'/>
         <img src={pic5} className='h-[65px] md:h-[80px]'/>     
        </div>
        </div>
     </div>
      </div>

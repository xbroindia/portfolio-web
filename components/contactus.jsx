...
export default function ContactUs() {
  ...
  return (
    <>
    <div className="min-h-[100vh] mt-[120px] lg:mt-[100px]  scroll-mt-[100px]"  id="contactus">
  ...
  className={`relative inline-block px-10 py-4 text-[17px] font-medium uppercase rounded-full transition-all duration-200 overflow-hidden group 
    ${state.submitting ? 'bg-gray-300 text-gray-500 cursor-not-allowed' : 'bg-white text-black hover:-translate-y-[3px] hover:shadow-[0_10px_20px_rgba(0,0,0,0.2)] active:translate-y-[-3px] active:shadow-[15px_15px_15px_rgba(0,0,0,1)]'} cursor-pointer`}
>
